...
class CMakeBuild(build_ext):
  ...
  def build_extension(self, ext):
    ...
    if os.getenv('CUSTOM_BLAS_DIR'):
      cmake_args += ['-DCUSTOM_BLAS_DIR=' + os.getenv('CUSTOM_BLAS_DIR')]
...
with open(README_PATH, "r") as handle:
  ...
  LONG_DESCRIPTION = re.search("##.*([^#]*)##", handle.read()).group(1)
...
setup(
  ...
  author="Meixu Song",
  author_email="songmeixu@outlook.com",
  url='https://github.com/open-speech/tf_kaldi_io',
  license='MIT',
